...
class _LanguageStateful extends State<LanguageStateful> {
  ...
  void _updateLanguage(String language){
    ...
    if(Platform.isAndroid){
      tts.isLanguageInstalled(language).then((value) => isCurrentLanguageInstalled = (value as bool));
    }  
  }
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, index){
                    return ListTile(
                      ...
                      trailing: (language == (snapshot.data[index] as String)) ? Icon(Icons.check) : null,
                    );
                  });
              }
              else if(snapshot.hasError){
