import 'dart:io';
import 'package:cboard_mobile/onboarding/utils.dart';
...
class UserHeader extends StatefulWidget {
  bool shouldSetPhoto;
  UserHeader({Key key, this.shouldSetPhoto = true})
      : super(key: key);
      ...
      child: Column(
        children: [
          widget.shouldSetPhoto ?
            Container(
              child: Image.asset('assets/images/user.png', scale: 0.75, fit: BoxFit.fill),
            ):
            Container(
              width: screenWidth/5,
              height: screenHeight/10,
              child: Image.file(_profilePicture, scale:0.55, fit: BoxFit.fill),
            ),
          widget.shouldSetPhoto
              ? InkWell(
                onTap: (){
