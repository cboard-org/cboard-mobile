...
// import 'package:cboard_mobile/sharedWidgets/Themes.dart';
...
class SettingWrapper extends StatelessWidget {
  ...
  final Map<String, Map<String, SettingListItem>> section = {
    'settings_people': {
      'settings_people_Guest':
          new SettingListItem(Icons.account_circle, '/welcome')
    },
    'settings_language': {
      'settings_language_Language':
          new SettingListItem(Icons.language, '/language'),
      'settings_language_Speech':
          new SettingListItem(Icons.record_voice_over, '/speech')
    },
    'settings_system': {
      'settings_system_Export':
          new SettingListItem(Icons.cloud_upload, '/export'),
      'settings_system_Import':
          new SettingListItem(Icons.cloud_download, '/import'),
      'settings_system_Display':
          new SettingListItem(Icons.remove_red_eye, '/display'),
      'settings_system_Scanning':
          new SettingListItem(Icons.center_focus_strong, '/scanner'),
      'settings_system_Navigation':
          new SettingListItem(Icons.chevron_right, '/navigation')
    },
    'settings_help': {
      ...
      'settings_help_Donate':
          new SettingListItem(Icons.monetization_on, '/donate'),
                    ...
                    children: [
                      Text(
                        AppLocalizations.of(context)
                            .translate(section.keys.elementAt(index)),
                          ...
                          ? ListTile(
                              ...
                              trailing: Button(
                                ...
                                label: Text(AppLocalizations.of(context)
                                    .translate("settings_login_button")),
                                isPrimary: false,
                                onPress: () {
